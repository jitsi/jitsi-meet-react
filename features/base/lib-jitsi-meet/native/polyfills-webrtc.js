(function (global) {
    ...
    if (typeof global.webkitRTCPeerConnection === 'undefined') {
         ...
         * onaddstream before it remembers remotedescription (and thus
         * makes it available to API clients). Because that appears to be a
         * problem for lib-jitsi-meet which has been successfully running
         * on Chrome, Firefox, Temasys, etc. for a very long time, attempt
         * to meets its expectations (by extending RTCPPeerConnection).
         *
         * @class
         */
